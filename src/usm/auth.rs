...
mod tests {
    ...
    fn given_correct_key_when_compute_sha256_mac_then_returns_24_bytes() {
        ...
        let mac = AuthProtocol::HmacSha256.compute_mac(&key, b"hello").unwrap();
    ...
    fn given_correct_key_when_compute_sha512_mac_then_returns_48_bytes() {
        ...
        let mac = AuthProtocol::HmacSha512.compute_mac(&key, b"hello").unwrap();
    ...
    fn given_same_message_and_key_when_compute_mac_twice_then_same_result() {
        ...
        let mac1 = AuthProtocol::HmacSha256.compute_mac(&key, b"test message").unwrap();
        let mac2 = AuthProtocol::HmacSha256.compute_mac(&key, b"test message").unwrap();
        assert_eq!(mac1, mac2);
    }
    ...
    fn given_different_messages_when_compute_mac_then_different_results() {
        ...
        let mac1 = AuthProtocol::HmacSha256.compute_mac(&key, b"message one").unwrap();
        let mac2 = AuthProtocol::HmacSha256.compute_mac(&key, b"message two").unwrap();
        assert_ne!(mac1, mac2);
    }
    ...
    fn given_tampered_mac_when_verify_then_mac_mismatch_error() {
        ...
        let mut mac = AuthProtocol::HmacSha256.compute_mac(&key, b"authentic").unwrap();
    ...
    fn given_tampered_message_when_verify_then_mac_mismatch_error() {
        ...
        let mac = AuthProtocol::HmacSha256.compute_mac(&key, b"original").unwrap();
        assert_eq!(
